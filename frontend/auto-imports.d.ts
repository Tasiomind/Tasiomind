...
declare global {
  ...
  const useToast: typeof import('vue3-toastify')['useToast']
  ...
  const withDefaults: typeof import('@vueuse/core')['withDefaults']
  const withDefaultsRef: typeof import('@vueuse/core')['withDefaultsRef']
  const withDefaultsRefHistory: typeof import('@vueuse/core')['withDefaultsRefHistory']
  const withDefaultsRefShallow: typeof import('@vueuse/core')['withDefaultsRefShallow']
}
// for type re-export
declare global {
  // @ts-ignore
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly useToast: UnwrapRef<typeof import('vue3-toastify')['useToast']>
