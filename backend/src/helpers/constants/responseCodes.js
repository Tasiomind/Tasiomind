...
export const USER_USERNAME_INVALID_FORMAT_ERROR = 'UserUsernameInvalidFormatError';
...
export const USER_PHONE_NUMBER_UNAVAILABLE_ERROR = 'UserPhoneNumberUnavailableError';
...
export const APPLICATION_DESCRIPTION_LEN_ERROR = 'ApplicationDescriptionLenError';
export const APPLICATION_DESCRIPTION_EMPTY_ERROR = 'ApplicationDescriptionEmptyError';
...
export const PERMISSION_SCOPE_INVALID_FORMAT_ERROR = 'PermissionScopeInvalidFormatError';
export const PERMISSION_DESCRIPTION_LEN_ERROR = 'PermissionDescriptionLengthError';
export const PERMISSION_DESCRIPTION_EMPTY_ERROR = 'PermissionDescriptionEmptyError';
...
// resolvers
export const INCORRECT_EMAIL = 'IncorrectEmail';
...
export const USER_UNBLOCKED = 'UserUnblocked';
export const USER_NOT_BLOCKED = 'UserNotBlocked';
export const USER_LOCKED = 'UserLocked';
export const USER_UNLOCKED = 'UserUnlocked';
export const USER_NOT_LOCKED = 'UserNotLocked';
